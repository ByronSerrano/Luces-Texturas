...
class TexturedObjects(PyOGLApp):
    def __init__(self):
        ...
        self.lights = []
        self.cube_textured = None
        self.cube_colored = None
    ...
    def initialise(self):
        ...
        # Crear dos cubos con diferentes texturas
        self.cube_textured = LoadMesh(
                    join_path("models", "cube.obj"), 
                    join_path("images", "crate.png"),
                    location=pygame.Vector3(0, -1.5, 0),
                    material=self.material_textured)

        # Para el cubo sin textura, usa una imagen de color sólido o una textura simple
        self.cube_colored = LoadMesh(
                    join_path("models", "cube.obj"), 
    ...
    def display(self):
        ...
        # Dibujar el cubo según el estado actual
        if self.show_texture:
            self.cube_textured.draw(self.camera, self.lights)
        else:
            self.cube_colored.draw(self.camera, self.lights)
