...
class IronManShader(PyOGLApp):
    ...
    def initialise(self):
        ...
        self.ironman = LoadMesh("models/ironman.obj", "images/gold.png",  # draw_type=GL_POLYGON,
    ...
    def display(self):
        ...
        self.ironman.draw(self.camera, self.lights)

        # glDrawArrays(GL_LINE_LOOP, 0, self.vertex_count)


IronManShader().mainloop()
